...
// ==============================================================
#ifndef __top_fcmp_32ns_32nfYi__HH__
#define __top_fcmp_32ns_32nfYi__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(top_fcmp_32ns_32nfYi) {
    ...
    SC_CTOR(top_fcmp_32ns_32nfYi):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
