...
module AESL_automem_input_data (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.top.autotvin_input_data.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.top.autotvout_input_data.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 14;
parameter DEPTH = 32'd 12288;
parameter DLY = 0.1;
