...
module AESL_automem_output_data (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.top.autotvin_output_data.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.top.autotvout_output_data.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 32;
parameter ADDR_WIDTH = 32'd 12;
parameter DEPTH = 32'd 4096;
parameter DLY = 0.1;
